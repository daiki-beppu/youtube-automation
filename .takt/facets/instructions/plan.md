...
2. **Knowledge / Policy の確認（提供されている場合）**
   - Knowledge / Policy の Source Path が渡されている場合は Read ツールで開き、今回の設計判断に影響する `##` セクションを確認する
   - 実装アプローチと Coder 向け実装ガイドラインに、適用した制約と避けるべきアンチパターンを反映する
3. タスクの要件を理解する
