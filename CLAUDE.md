...
- `src/youtube_automation/{utils,agents,commands,templates}/` — コアライブラリ / アップロードエージェント / `yt-*` CLI の thin adapter（domain 別に分割）/ 説明文テンプレート。console script の wrapper は `entrypoints.py`
