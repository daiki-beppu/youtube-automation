...
- `feat(suno)`: Suno V5.5 向けプロンプト設計を更新し、ボーカル曲用の `/suno-lyric` スキルと lyric reference を追加。`suno-lyrics.json` の entry name 完全一致検証と auto-prep slug safety guidance も追加（#1305）
