...
import { DEFAULT_URL, SERVER_SOURCES_STORAGE_KEY } from "../../shared/constants";
import { migrateLegacyServerSources } from "../../shared/server-source-migration";

// サーバー URL の永続化アイテム（local area）。
export const serverUrlItem = storage.defineItem<string>("local:serverUrl", { fallback: DEFAULT_URL });
