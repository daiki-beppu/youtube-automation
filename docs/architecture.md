...
- `src/youtube_automation/domains/media/audio_adjustments.py` — `audio-adjustments.json` の cleanup 差分・確定曲順・master 全体調整を検証し、実ファイル集合との一致確認と他段キーを保つ原子的更新を所有する
