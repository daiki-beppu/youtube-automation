...
`/wf-new` は `workflow-state.json` を **新規作成し自動更新する**。ユーザーが手で編集してはいけない（[扱い基準](https://github.com/daiki-beppu/youtube-automation/blob/main/docs/workflow-cheatsheet.md#workflow-statejson-の扱い)）。
