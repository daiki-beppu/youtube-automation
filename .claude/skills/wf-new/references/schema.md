...
|-----|-------------------|-----|
| `planning.activities` | `/ideate` 等 | プレイリストアクティビティの override (`scripts/playlist_manager.py`) |
| `planning.target_persona` | `/ideate` | 企画選択時のターゲットペルソナ記録 |
| `planning.final_title` | `/ideate` | 確定タイトル |
| `planning.generated` | `/ideate` | 企画完了フラグ |
