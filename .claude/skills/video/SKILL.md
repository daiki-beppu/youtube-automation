...
- `読み込む`: `collections/<id>/01-master/<master-audio>`, `collections/<id>/10-assets/main.png`, `collections/<id>/10-assets/main.jpg`, `collections/<id>/10-assets/loop.mp4`, `collections/<id>/20-documentation/suno-prompts.md`, `data/benchmark_*.json`, `docs/benchmarks/*.md`, `config/channel/*.json`, `config/skills/video.yaml`
