...
| **[Recraft V4](https://www.recraft.ai/)** | Check current provider pricing | **The only mainstream model with production-grade SVG output.** Logos, icons, illustrations that need to live in code and scale. | SVG + PNG |
