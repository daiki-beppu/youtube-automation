...
python3 automation/benchmark_collector.py

# オプション
python3 automation/benchmark_collector.py --force            # 全チャンネル強制更新
python3 automation/benchmark_collector.py --no-thumbnails    # サムネイル分析スキップ（高速）
python3 automation/benchmark_collector.py --keep-thumbnails  # サムネイル画像を保持
python3 automation/benchmark_collector.py --json-only        # JSON のみ（Markdown スキップ）
python3 automation/benchmark_collector.py --channel <slug>   # 単一チャンネル指定
python3 automation/benchmark_collector.py -v                 # 詳細ログ
```
