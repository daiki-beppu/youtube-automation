#!/usr/bin/env python3
"""Generate suno-prompts.md from config/skills/music.yaml::prompt + suno-patterns.yaml."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate suno-prompts.md from config/skills/music.yaml::prompt + suno-patterns.yaml",
    )
    parser.add_argument(
        "path",
        nargs="?",
