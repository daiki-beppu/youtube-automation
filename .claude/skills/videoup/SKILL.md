...
- `前工程`: `/automation-run`, `/masterup`, `/lyria`, `/loop-video`
...
| `bash "$(git rev-parse --show-toplevel)/.claude/skills/videoup/references/generate_videos.sh" --preview 20 <path>` | effect / overlay を反映した 15〜30 秒の確認用サンプルを生成（既定 20 秒） |
