...
| コマンド | 説明 |
|---------|------|
| `bash .claude/skills/masterup/references/generate_master.sh` | CWD のコレクションでマスター音源生成 |
| `bash .claude/skills/masterup/references/generate_master.sh <path>` | 指定コレクションでマスター音源生成 |
| `bash .claude/skills/videoup/references/generate_videos.sh` | CWD のコレクションで全動画生成（コレクションディレクトリ内で実行） |
| `bash .claude/skills/videoup/references/generate_videos.sh <path>` | 指定コレクションで全動画生成 |
