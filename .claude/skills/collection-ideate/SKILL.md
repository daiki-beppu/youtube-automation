...
> 制作ループ全体の中での位置づけと `workflow-state.json` の扱いは [`docs/workflow-cheatsheet.md`](https://github.com/daiki-beppu/youtube-automation/blob/main/docs/workflow-cheatsheet.md) を参照。
