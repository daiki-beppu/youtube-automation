...
- 「新チャンネル」「チャンネル追加」「チャンネル開設」など新規開設の依頼は本スキルで受けず、`/setup --channel` へ案内する
