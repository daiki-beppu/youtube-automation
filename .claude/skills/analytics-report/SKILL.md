...
- Shorts は動画パフォーマンス表から除外（タイトルに `#Shorts` を含む動画）。Complete Collection と KPI 構造（CTR / Avg Duration / 視聴維持の意味合い）が異なり同じ表で比較できないため。v5.5.1 で `/short` 由来の Shorts が増えても本表の集計対象外
