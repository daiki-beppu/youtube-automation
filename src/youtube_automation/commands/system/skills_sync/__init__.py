...
# submodule 側の `from youtube_automation.commands.system.skills_sync import ...` が解決できる。
# `as` alias は ruff F401 を抑止する canonical re-export 記法。
from youtube_automation.commands.system.skills_sync._ops import _copy_entry as _copy_entry  # noqa: E402, I001
from youtube_automation.commands.system.skills_sync._ops import _ensure_target_parent as _ensure_target_parent  # noqa: E402
