...
def build_launch_curve_frame(
    ...
    df["daily_views"] = pd.to_numeric(df["daily_views"], errors="coerce").fillna(0).astype(int)
    df["daily_impressions"] = pd.to_numeric(df["daily_impressions"], errors="coerce").fillna(0).astype(int)
