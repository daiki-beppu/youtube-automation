...
def get_channel_latest_status():
    ...
    try:
        ...
        if video_ids:
            ...
            try:
                response = collector.analytics_service.reports().query(
    ...
    if args.json:
        ...
        for i, collection in enumerate(status['recent_collections'], 1):
            ...
            if s:
                ...
                print(f"      👀 {s['views']:,} views  ⏱ {s['watch_time_min']:,.0f}min watched"
