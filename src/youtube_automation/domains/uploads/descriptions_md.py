...
__all__ = ["extract_body_for_localizations", "extract_md_section", "load_descriptions_md"]


def load_descriptions_md(collection_dir: Path) -> dict | None:
    """descriptions.md から事前生成メタデータを読み込む。
...
def extract_body_for_localizations(description: str) -> str | None:
    """キュレーション済み概要欄からローカライゼーション用タイムスタンプを抽出する。"""
