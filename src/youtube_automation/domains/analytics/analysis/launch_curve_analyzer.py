"""Launch-curve benchmark calculations and classification policy."""
...
def compute_benchmark(
    ...
    """Calculate percentile benchmarks grouped by video age."""
...
def judge_video_vs_benchmark(
    ...
    """Compare a video's value at a given age with its benchmark."""
...
__all__ = ["compute_benchmark", "judge_video_vs_benchmark"]
